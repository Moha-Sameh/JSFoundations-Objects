...
function getChannelByName(channelName = "", channels) {
  const result = channels.find(({ name }) => name === channelName);
  return result;
}
...
function getChannelByVideoTitle(videoTitle, channels) {
  // Your code here return channel.videos.some((video) => video.title === videoTitle);
  let videoobj = channels.find((channel) => {
